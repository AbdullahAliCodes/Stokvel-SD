...
export default function MeetingDetails() {
  ...
  return (
    <div className="max-w-2xl text-stone-800">
      ...
      <h1 className="mb-8 border-b border-stone-200 pb-4 text-3xl font-bold tracking-tight text-emerald-800">
        Q1 planning
      </h1>
      ...
      <div className={`${cardLight} space-y-8 p-6`}>
        <section>
          ...
          <p className="text-lg text-stone-800">Avoille Stokvel</p>
        </section>
        ...
        <section>
          ...
          <p className="text-stone-700">Saturday, 12 April 2026 — 10:00</p>
        </section>
