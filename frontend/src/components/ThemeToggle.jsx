...
const headerBtn =
  'stkg-btn inline-flex shrink-0 items-center justify-center rounded-lg border border-emerald-800/20 bg-white p-2.5 text-emerald-900 shadow-sm transition hover:border-emerald-800/35 hover:bg-emerald-50/90 dark:border-slate-600 dark:bg-slate-800 dark:text-amber-200 dark:hover:border-slate-500 dark:hover:bg-slate-700'

/** Member dashboard sidebar — full width row above logout */
const sidebarBtn =
  'stkg-btn flex w-full items-center justify-center rounded-lg border border-stone-200 bg-stone-50 py-2.5 text-stone-700 shadow-sm transition hover:bg-stone-100 dark:border-slate-600 dark:bg-slate-800 dark:text-amber-200 dark:hover:bg-slate-700'
