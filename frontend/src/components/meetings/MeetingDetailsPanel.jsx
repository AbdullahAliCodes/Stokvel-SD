  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 w-full max-w-md ${cardLight} max-h-[85vh] overflow-y-auto border border-stone-200 p-4 shadow-lg sm:p-5`}
      ...
      >
        ...
        {meetings.length === 0 ? (
          <p className="text-sm text-stone-600">No meetings on this day.</p>
        ) : (
          <ul className="space-y-3">
            {meetings.map((m) => (
              ...
              >
                <p className="font-semibold text-stone-800">{m.title || "Meeting"}</p>
