...
export default function DashboardLayout() {
  return (
    <div className="flex min-h-screen flex-col gap-4 bg-[#F4F5F0] px-4 pb-8 pt-2 text-stone-800 md:flex-row md:px-8">
      <aside className="flex w-full flex-col rounded-2xl border border-stone-200 bg-white shadow-sm md:max-w-[220px] md:shrink-0">
        ...
        <Link
          to="/home"
          className="mx-2 mb-2 flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-stone-600 transition hover:bg-stone-100 hover:text-stone-900"
        >
      ...
      <main className="min-w-0 flex-1 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm md:p-8">
        <Outlet />
      </main>
    </div>
  )
